  ...
  angular.module('angularDaumMap')
    .directive('daumMap', function ($timeout, $log) {
      ...
      return {
        ...
        transclude: true,
        replace: false,
        template: '<div id ="map" class="angular-daum-map" style="width:100%;height:'+(window.innerHeight-100)+'px"><div class="angular-daum-map-container" style="width:100%;height:100%"></div><div ng-transclude style="display:none"></div></div>',
        scope: {
          center: '=center',
          level: '=level',
          mapTypeId: '=mapTypeId',
